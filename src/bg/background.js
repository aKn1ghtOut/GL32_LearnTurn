(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    ...
    exports.default = DDP;
    window.DDP = DDP;
    },{"./queue":2,"./socket":3,"./utils":4,"wolfy87-eventemitter":5}],2:[function(require,module,exports){
    "use strict";
    ...
    },{"wolfy87-eventemitter":5}],4:[function(require,module,exports){
    "use strict";
  ...
  startSession = async () => {
    try{
      ...
      const pass = await digestMessage("password");
      console.log({ pass });
  
      let login = socketeer.method("login", [
        {
          "user": { "email":    "ab342@snu.edu.in" },
          "password":
                {
                    "digest":       pass,
                    "algorithm":    "sha-256"
      ...
      return new Promise(resolve => {
        socketeer.on("result", (message) => {
          if (message.id === login && !message.error) {
  ...
  const sendStuff = look => {
    if(!started)
    return false;

    chrome.tabs.get(tabId, tab => {
        dataState.tabStatus = tab.highlighted;
        // if(new Date() - dataState.lastReported > 2)
        // {
        //     dataState.looking = false;
        //     console.log(new Date() - dataState.lastReported );
        // }
  ...
  const connectClicked = (sendResponse) => {
    //When connect in popup clicked
    doInCurrentTab(tab => processCurrentTab(tab));
  ...
  const disconnectClicked = (sendResponse) => {
    //When connect in popup clicked
    socketeer.disconnect && socketeer.disconnect();
    chrome.storage.local.set({ status: "disconnected" });
    started = false;
    return sendResponse();
  }
  ...
  chrome.extension.onMessage.addListener(
    function(request, sender, sendResponse) {
      ...
      {
        case "connect":
          return connectClicked(sendResponse);
          break;
  
        case "disconnect":
          return disconnectClicked(sendResponse);
          break;
